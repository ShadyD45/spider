...
${COMPOSE_CMD} exec central-tracker /usr/local/bin/spiderctl peers --tracker=127.0.0.1:50051
...
${COMPOSE_CMD} exec worker-1 /usr/local/bin/spiderctl publish \
...
${COMPOSE_CMD} exec worker-2 /usr/local/bin/spiderctl sync \
...
${COMPOSE_CMD} exec worker-2 /usr/local/bin/spiderctl status --daemon=127.0.0.1:50052
...
${COMPOSE_CMD} exec worker-3 /usr/local/bin/spiderctl sync \
  --manifest=/data/manifest-v1.json \
  --dest=/data/dest/model-v1 \
